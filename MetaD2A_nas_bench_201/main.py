...
def get_parser():
  ...
  parser.add_argument('--model_name', type=str, default='generator', help='select model [generator|predictor]')
  parser.add_argument('--save-path', type=str, default='C:\\Users\\gress\\OneDrive\\Documents\\Gresa\\DeepKernelGP\\MetaD2A_nas_bench_201\\results', help='the path of save directory')
  parser.add_argument('--data-path', type=str, default='C:\\Users\\gress\\OneDrive\\Documents\\Gresa\\DeepKernelGP\\MetaD2A_nas_bench_201\\data', help='the path of save directory')
  ...
  parser.add_argument('--batch_size', type=int, default=1, help='batch size for generator')
